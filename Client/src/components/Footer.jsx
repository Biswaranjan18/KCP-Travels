...
import CompanyP_logo from '../assets/CompanyP_logo.webp';
    ...
    <footer className="bg-gray-900 text-white px-6 py-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-300 mt-2">
            Explore the soul of incredible Odisha with comfort and trust.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-300">
            <li className="flex items-center gap-3 hover:text-orange-400 transition-colors duration-300">
              ...
              <span>+91 82609 75372</span>
            </li>
            <li className="flex items-center gap-3 hover:text-orange-400 transition-colors duration-300">
              <FiMessageCircle className="text-orange-400 flex-shrink-0" /> 
              <span>+91 76068 28043</span>
            </li>
            <li className="flex items-center gap-3 hover:text-orange-400 transition-colors duration-300">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="#" className="w-10 h-10 rounded-full bg-gray-700 hover:bg-orange-500 flex items-center justify-center transition-colors duration-300">
      ...
      <div className="border-t border-gray-700 mt-10 pt-6 text-center text-gray-400 text-sm">
        <div className="flex flex-col md:flex-row justify-center items-center gap-4">
          <span>© 2025 KCP Travels Odisha. All Rights Reserved.</span>
